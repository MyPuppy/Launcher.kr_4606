...
namespace RiderData
{
    public static class NewRider
    {
                ...
                if (SetRiderItem.Set_KartSN == Launcher.KartOld_SN)
                {
                    ...
                    if (Program.UseKartLevel)
                    {
                        if (SetRiderItem.Set_Kart <= 292 || SetRiderItem.Set_Kart == 358 || SetRiderItem.Set_Kart == 420 || SetRiderItem.Set_Kart == 464 || SetRiderItem.Set_Kart == 501 ||
                            ...
                            SetRiderItem.Set_Kart == 1212 || SetRiderItem.Set_Kart == 1215 || SetRiderItem.Set_Kart == 1221 || SetRiderItem.Set_Kart == 1222)
                        {
                            oPacket.WriteByte(0);
                        }
                        else
        ...
        {
            NewRider.Kart_X_Cut = 57;
            NewRider.Kart_Old_Cut = 299;
            ...
            using (OutPacket oPacket = new OutPacket("LoRpGetRiderItemPacket"))
            {
                ...
                for (short i = 1; i <= NewRider.MaxKart; i++)
                {
                    if (i <= 25 || i == 27 || i == 29 || i == 45 || i == 54 || i == 59 ||
                        ...
                        i == 1094 || i == 1095 || i == 1098 || i == 1103 || i == 1137 || i == 1193 || i == 1195 || i == 1199 || i == 1206 || i == 1208 || i == 1212 || i == 1215 || i == 1221 || i == 1222 || //old
                        ...
                        i == 1191 || i == 1192 || i == 1196 || i == 1203 || i == 1204 || i == 1209 || i == 1213 || i == 1214 || i == 1217 || i == 1218 || i == 1219 || i == 1220) //X
                    {
                        oPacket.WriteShort(3);
                        oPacket.WriteShort(i);
                        if (i <= 1095 || i == 1098 || i == 1103 || i == 1137 || i == 1193 || i == 1195 || i == 1199 || i == 1206 || i == 1208 || i == 1212 || i == 1215 || i == 1221 || i == 1222)
                        {
                            oPacket.WriteShort(Launcher.KartOld_SN);
                        }
                        else
        ...
        public static void Character()
        {
            using (OutPacket oPacket = new OutPacket("LoRpGetRiderItemPacket"))
            {
                ...
                oPacket.WriteInt(1);
                int Character = 321;
                oPacket.WriteInt(Character - 32 - 35);
